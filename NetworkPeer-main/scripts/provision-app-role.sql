...
REVOKE EXECUTE ON FUNCTION resolve_cognito_user(TEXT, VARCHAR, user_role) FROM PUBLIC;
...
GRANT EXECUTE ON FUNCTION resolve_cognito_user(TEXT, VARCHAR, user_role) TO networkpeer_app;
